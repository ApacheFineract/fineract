...
public class CurrenciesTest {
    ...
    public void testCreateCurrencyPostApi_CurrencyCodeNotEqualToNull() throws IOException {
      CurrencyData createCurrencyData = new CurrencyData()
          .code("XYZ")
          .decimalPlaces(2)
          .displaySymbol("¤")
          .inMultiplesOf(1)
...
//      // Make the call using fineract-client and Calls.ok(...)
//      CurrencyData results = Calls.ok(FineractClientHelper.getFineractClient().currencies.createCurrencies(createCurrencyData));
////      assertThat(results.)
