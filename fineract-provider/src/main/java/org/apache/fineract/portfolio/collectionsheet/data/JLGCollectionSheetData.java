...
@Builder
@EqualsAndHashCode
public final class JLGCollectionSheetData implements Serializable {

    @Serial
    private static final long serialVersionUID = 1L;

    private final LocalDate dueDate;
    private final Set<LoanProductData> loanProducts;
    private final List<SavingsProductData> savingsProducts;
    private final List<JLGGroupData> groups;
    ...
    public static JLGCollectionSheetData withSavingsProducts(final JLGCollectionSheetData data,
            final List<SavingsProductData> savingsProducts) {
