...
public class CollectionSheetDao {
  ...
  public List<IndividualCollectionSheetLoanFlatData> getIndividualCollectionSheetFlatDataList(LocalDate transactionDate, String officeHierarchy, Long officeId, Long staffId) {
    ...
    final StringBuilder sqlString = getIndividualCollectionSheetFlatDataSql(checkForOfficeId,
            checkForStaffId);

    final SqlParameterSource namedParameters = getNamedParameters(transactionDateStr,
            officeHierarchy, officeId, staffId);

    return this.namedParameterJdbcTemplate
    .query(sqlString.toString(), namedParameters, rowMapper());
  }
  ...
  private RowMapper<IndividualCollectionSheetLoanFlatData> rowMapper() {
    return (rs, rowNum) -> {
      ...
      return new IndividualCollectionSheetLoanFlatData(
              clientName,
              clientId,
              loanId,
              accountId,
  ...
  public List<IndividualClientData> getIndividualClientData(String transactionDateStr,
    ...
    return this.namedParameterJdbcTemplate
            .query(sqlString.toString(), namedParameters, individualClientDataExtractor());
  }

  private StringBuilder getIndividualClientDataSql(final boolean checkForOfficeId,
