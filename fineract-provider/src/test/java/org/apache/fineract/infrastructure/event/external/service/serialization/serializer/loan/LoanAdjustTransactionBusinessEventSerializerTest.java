...
public class LoanAdjustTransactionBusinessEventSerializerTest {
    ...
    // final List<ExternalEventCustomDataSerializer<LoanAdjustTransactionBusinessEvent>>
    ...
    // LoanAdjustTransactionBusinessEvent.Data loanAdjustTransactionBusinessEventData = new
    ...
    //
    // LoanTransactionData transactionToAdjustData = new LoanTransactionData(1L, 1L, "",
    // LoanEnumerations.transactionType(2), null, null,
    ...
    // new ExternalId("testExternalId"), null, null, BigDecimal.valueOf(0.0),
